...
const AdminNav: FC<Props> = ({navItems}): JSX.Element => {
    ...
    return <nav ref={navRef} className="h-screen w-60 shadow-sm 
   ...
   <div>
     {/* logo */}
       ...
       <Link href="/admin" className="flex items-center space-x-2 p-3 mb-10">
        ...
        {visible && <span className="text-highlight-light 
        dark:text-highlight-dark text-xl font-semibold leading-none">
        Admin
        </span>}
        </Link> 
     ...
     <button onClick={updateNavState} className="text-highlight-light dark:text-highlight-dark 
