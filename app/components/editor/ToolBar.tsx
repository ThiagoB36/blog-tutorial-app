...
const handleLinkSubmit = ({url, openInNewTab}:linkOpition) => {
    ...
    if(openInNewTab) commands.setLink({href: url, target: "_blanck" });
...
const Head = () => {
    ...
    // heading 1, 2, 3 "bold" "italic" "undeline" "strike" "quote" "code" "code-block" 
    // "insert-link" "lists (ol and ul)" "embed youtube" "insert image" 
